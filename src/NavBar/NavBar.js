        ...
        <AppBar position="fixed" color='primary' className={classes.appBar}>
          <Toolbar>
            ...
            <Chip
              ...
              style={this.props.sensorEvents.wind ? this.props.windSense.direction !== null ? {marginLeft: 'auto', backgroundColor: 'white', fontWeight: 600, color: '#54aab3', fontSize: '0.875rem'} : {marginLeft: 'auto', backgroundColor: '#ff000080', color: 'white', fontWeight: 600, fontSize: '0.875rem'} : {marginLeft: 'auto', backgroundColor: '#ff000080', color: 'white', fontWeight: 600, fontSize: '0.875rem'}}
