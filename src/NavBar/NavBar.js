      ...
      <div className={classes.root}>
        ...
        <AppBar position="fixed" color='primary' className={classes.appBar}>
          <Toolbar>
            ...
            <Chip
              icon={<Snow />}
              style={this.props.sensorEvents.snow ? this.props.snowSense !== null ? {marginLeft: 'auto', backgroundColor: 'white', fontWeight: 600, color: '#54aab3', fontSize: '0.875rem'} : {marginLeft: 'auto', backgroundColor: '#ff000080', color: 'white', fontWeight: 600, fontSize: '0.875rem'} : {marginLeft: 'auto', backgroundColor: '#ff000080', color: 'white', fontWeight: 600, fontSize: '0.875rem'}}
              label={this.props.sensorEvents.snow ? this.props.snowSense !== null ? `${this.props.snowSense.toFixed(2)} mm` : 'offline' : 'offline'}
              classes={this.props.sensorEvents.snow ? this.props.snowSense !== null ? {icon: classes.iconTeal} : {icon: classes.icon} : {icon: classes.icon}}
            />
            <Chip
              icon={<Flood/>}
              style={this.props.sensorEvents.flood ? this.props.floodSense !== null ? {marginLeft: 10, backgroundColor: 'white', fontWeight: 600, color: '#54aab3', fontSize: '0.875rem'} : {marginLeft: 10, backgroundColor: '#ff000080', color: 'white', fontWeight: 600, fontSize: '0.875rem'} : {marginLeft: 10, backgroundColor: '#ff000080', color: 'white', fontWeight: 600, fontSize: '0.875rem'}}
              label={this.props.sensorEvents.flood ? this.props.floodSense !== null ? `${this.props.floodSense.toFixed(2)} mm` : 'offline' : 'offline'}
              classes={this.props.sensorEvents.flood ? this.props.floodSense !== null ? {icon: classes.iconTeal} : {icon: classes.icon} : {icon: classes.icon}}
            />
            <Chip
              ...
              style={this.props.sensorEvents.wind ? this.props.windSense.direction !== null ? {marginLeft: 10, backgroundColor: 'white', fontWeight: 600, color: '#54aab3', fontSize: '0.875rem'} : {marginLeft: 10, backgroundColor: '#ff000080', color: 'white', fontWeight: 600, fontSize: '0.875rem'} : {marginLeft: 10, backgroundColor: '#ff000080', color: 'white', fontWeight: 600, fontSize: '0.875rem'}}
              ...
              classes={this.props.sensorEvents.wind ? this.props.windSense.direction !== null ? {icon: classes.iconSVGTeal} : {icon: classes.iconSVG} : {icon: classes.iconSVG}}
            />
            <Chip
              icon={<Toys className={this.props.sensorEvents.wind ? this.props.windSense.speed !== null ? this.props.windSense.speed !== 0 ? 'rotate' : {} : {}: {}}/>}
              style={this.props.sensorEvents.wind ? this.props.windSense.speed !== null ? {marginLeft: 10, backgroundColor: 'white', fontWeight: 600, color: '#54aab3', fontSize: '0.875rem'} : {marginLeft: 10, backgroundColor: '#ff000080', color: 'white', fontWeight: 600, fontSize: '0.875rem'} : {marginLeft: 10, backgroundColor: '#ff000080', color: 'white', fontWeight: 600, fontSize: '0.875rem'}}
              label={this.props.sensorEvents.wind ? this.props.windSense.speed !== null ? `${this.props.windSense.speed.toFixed(2)} m/s` : 'offline' : 'offline'}
              classes={this.props.sensorEvents.wind ? this.props.windSense.speed !== null ? {icon: classes.iconTeal} : {icon: classes.icon} : {icon: classes.icon}}
            />
            <Chip
              icon={<Time />}
