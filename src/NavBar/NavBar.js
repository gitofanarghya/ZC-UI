      ...
      <div className={classes.root}>
        ...
        <AppBar position="fixed" color='primary' className={classes.appBar}>
          <Toolbar>
            ...
            <Chip
              icon={<Snow />}
              style={this.props.sensorEvents.snow ? this.props.snowSense !== null ? {marginLeft: 'auto', backgroundColor: 'white', fontWeight: 600, color: '#54aab3', fontSize: '0.875rem'} : {marginLeft: 'auto', backgroundColor: 'gray', color: 'white', fontWeight: 600, fontSize: '0.875rem'} : {marginLeft: 'auto', backgroundColor: 'gray', color: 'white', fontWeight: 600, fontSize: '0.875rem'}}
            ...
            <Chip
              ...
              style={this.props.sensorEvents.wind ? this.props.windSense.direction !== null ? {marginLeft: 10, backgroundColor: 'white', fontWeight: 600, color: '#54aab3', fontSize: '0.875rem'} : {marginLeft: 10, backgroundColor: 'gray', color: 'white', fontWeight: 600, fontSize: '0.875rem'} : {marginLeft: 10, backgroundColor: 'gray', color: 'white', fontWeight: 600, fontSize: '0.875rem'}}
            ...
            <Chip
              ...
              style={this.props.sensorEvents.wind ? this.props.windSense.speed !== null ? {marginLeft: 10, backgroundColor: 'white', fontWeight: 600, color: '#54aab3', fontSize: '0.875rem'} : {marginLeft: 10, backgroundColor: 'gray', color: 'white', fontWeight: 600, fontSize: '0.875rem'} : {marginLeft: 10, backgroundColor: 'gray', color: 'white', fontWeight: 600, fontSize: '0.875rem'}}
